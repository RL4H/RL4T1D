...
class AuxiliaryBuffer:
    def __init__(self, args):
        ...
        self.old_states = torch.zeros(self.size, args.feature_history, args.n_features, device=args.device, dtype=torch.float32)
        self.handcraft_feat = torch.zeros(self.size, 1, args.n_handcrafted_features, device=args.device, dtype=torch.float32)
