...
Once you have downloaded the pickled data, you will find it in a structure like the following:
...
If you instead run from the raw data, you should see the following structure:
