...
subject_attr_names = lines[0]
subject_attr_dict = dict()
for line in lines[1:]:
    subject_attr_dict[line[0].lower()] = dict()
    for c,var in enumerate(subject_attr_names):
...
if __name__ == "__main__":
    ...
    elif main_function == "pickle": # Import the raw data and convert it to pickled format
        import_raw_files()

    elif main_function == "import": # Import the pickled data
